*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVCOF_STATUS_UPD
*   generation date: 05.06.2023 at 16:32:20
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVCOF_STATUS_UPD    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVCOF_STATUS_UPD'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVCOF_STATUS_UPD_EXTRACT
TOTAL = ZVCOF_STATUS_UPD_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVCOF_STATUS_UPD'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVCOF_STATUS_UPD-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVCOF_STATUS_UPD_EXTRACT
TOTAL = ZVCOF_STATUS_UPD_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVCOF_STATUS_UPD-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVCOF_STATUS_UPD'
...
TOTAL = ZVCOF_STATUS_UPD_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVCOF_STATUS_UPD-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVCOF_STATUS_UPD-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVCOF_STATUS_UPD'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVCOF_STATUS_UPD-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVCOF_STATUS_UPD_EXTRACT
TOTAL = ZVCOF_STATUS_UPD_TOTAL
